...
namespace viviLib.Utils
{
    public class Utils
    {
        ...
        private static string TemplateCookieName = string.Format("dnttemplateid_{0}_{1}_{2}", (object)Utils.AssemblyFileVersion.FileMajorPart, (object)Utils.AssemblyFileVersion.FileMinorPart, (object)Utils.AssemblyFileVersion.FileBuildPart);
        ...
        {
            for (Match match = Utils.RegexBr.Match(str); match.Success; match = match.NextMatch())
        ...
        {
            return string.Format("{0}.{1}.{2}", (object)Utils.AssemblyFileVersion.FileMajorPart, (object)Utils.AssemblyFileVersion.FileMinorPart, (object)Utils.AssemblyFileVersion.FileBuildPart);
        }
        ...
        {
            return Utils.GetPageNumbers(curPage, countPage, url, extendPage, pagetag, (string)null);
        }
        ...
        {
            string[] strArray1 = Utils.SplitString(ip, ".");
            for (int index1 = 0; index1 < iparray.Length; ++index1)
            {
                string[] strArray2 = Utils.SplitString(iparray[index1], ".");
                int num = 0;
        ...
        public static bool IsCompriseStr(string str, string stringarray, string strsplit)
        {
            ...
            {
                str = str.ToLower();
                foreach (string str1 in Utils.SplitString(stringarray.ToLower(), strsplit))
                {
        ...
        {
            return Utils.RestoreFile(backupFileName, targetFileName, (string)null);
        }
