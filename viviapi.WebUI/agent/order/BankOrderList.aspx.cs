namespace viviapi.WebUI.agent.Order
{
    ...
    public class BankOrderList : AgentPageBase
    {
        ...
        protected void rptOrders_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            url = ((((((((url + "&ctype=" + this.ddlChannelType.SelectedValue) + "&userid=" + this.txtuserid.Text) + "&stime=" + this.StimeBox.Text) + "&etime=" + this.EtimeBox.Text) + "&mid=" + this.ddlmange.SelectedValue) + "&orderid=" + this.txtOrderId.Text) + "&userorder=" + this.txtUserOrder.Text) + "&supporder=" + this.txtSuppOrder.Text) + "&currpage=" + this.Pager1.CurrentPageIndex;
            try
            {
                string str2;
