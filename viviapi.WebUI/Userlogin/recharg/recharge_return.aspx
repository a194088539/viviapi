<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="recharge_return.aspx.cs"
    Inherits="viviapi.WebUI.Userlogin.recharg.recharge_return" %>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td height="26" align="left" class="zi17" valign="top">
                                                                    <a href="recharge.aspx"><span class="zi23">账户充值</span></a>&nbsp; | &nbsp;<a href="rechargelist.aspx"><span
                                                                        class="zi17">充值记录</span></a>&nbsp;
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 8px;">
                                                                <tr>
                                                                    <td style="font-family: '微软雅黑'; font-size: 17px;">
                                                                        <asp:Literal ID="litphone" runat="server"></asp:Literal><span style="color: #85b919;">充值金额<em style="font-size: 22px;"><%=successAmt%></em>元</span>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a href="/recharge.aspx">继续充值</a> <a href="/shou_transfer.aspx">转账功能</a> <a href="/shanghuzhongxin.aspx">
                                                                            返回商户中心</a>
                                                                    </td>
                                                                </tr>
                                                            </table>
