<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviapi.WebUI.Userlogin.recharg.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class="current"><a href="/Userlogin/recharg/index.aspx">账户充值</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="recharge.aspx" marginwidth="0" marginheight="0" frameborder="0"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="recharge.aspx" target="mainframe"><i class="icon-nav"></i>
                                    账户充值</a></li>
                                <li><a href="rechargelist.aspx" target="mainframe"><i class="icon-nav"></i>充值记录</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
