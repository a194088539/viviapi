<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviapi.WebUI.Userlogin.behalf.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class="current"><a href="/Userlogin/behalf/index.aspx">对私代发</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="import.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="import.aspx" target="mainframe"><i class="icon-nav"></i>
                                    代发上传</a></li>
                                <li><a href="importlist.aspx" target="mainframe"><i class="icon-nav"></i>上传记录</a></li>
                                <li><a href="importitems.aspx" target="mainframe"><i class="icon-nav"></i>上传明细</a></li>
                                <li><a href="agentdists.aspx" target="mainframe"><i class="icon-nav"></i>接口代发</a></li>
                                <li><a href="setting.aspx" target="mainframe"><i class="icon-nav"></i>代发设置</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
