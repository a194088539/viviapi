<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviapi.WebUI.Userlogin.order.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class="current"><a href="/Userlogin/order/index.aspx">订单管理</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="ordercards.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="ordercards.aspx" target="mainframe"><i class="icon-nav">
                                </i>卡类订单</a></li>
                                <li><a href="orderbank.aspx" target="mainframe"><i class="icon-nav"></i>网银订单</a></li>
                                <li><a href="cardreport.aspx" target="mainframe"><i class="icon-nav"></i>点卡通知</a></li>
                                <li><a href="bankreport.aspx" target="mainframe"><i class="icon-nav"></i>网银通知</a></li>
                                <li><a href="excha.aspx" target="mainframe"><i class="icon-nav"></i>批量销卡</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
