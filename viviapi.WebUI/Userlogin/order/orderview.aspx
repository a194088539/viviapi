<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderview.aspx.cs" Inherits="viviapi.WebUI.Userlogin.order.orderview" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .button
        {
            ...
            border-width: 1px;
            cursor: hand;
            background: url(/Userlogin/images/cxbg.gif);
        }
        .Mir_List
        {
            width: 100%;
