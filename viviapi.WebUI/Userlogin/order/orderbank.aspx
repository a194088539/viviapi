<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="orderbank.aspx.cs" Inherits="viviapi.WebUI.Userlogin.order.orderbank" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/Userlogin/ajax/replenish_new.ashx?v=" + Math.random(), { type: "1", order: orderid },
