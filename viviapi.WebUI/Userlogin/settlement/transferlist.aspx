<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transferlist.aspx.cs" Inherits="viviapi.WebUI.Userlogin.settlement.transferlist" %>
                ...
                <tr>
                    <td>
                        ...
                        从:<input id="edate" runat="server" type="text" class="search_txt_01"
                            onfocus="HS_setDate(this)" size="12" />
                        &nbsp;
                        受款方:<input name="okey" type="text" id="okey" runat="server" maxlength="30" value="" class="txt_01"  />
                        <label>
                            &nbsp;
