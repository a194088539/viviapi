<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviapi.WebUI.Userlogin.settlement.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class=""><a href="/Userlogin/product/index.aspx">商品管理</a></li>
                <li class="current"><a href="/Userlogin/settlement/index.aspx">结算提现</a></li>
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="applycost.aspx" marginwidth="0" marginheight="0" frameborder="0" scrolling="auto"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="applycost.aspx" target="mainframe"><i class="icon-nav">
                                </i>申请提现</a></li>
                                <li><a href="accountmoney.aspx" target="mainframe"><i class="icon-nav"></i>账户余额</a></li>
                                <li><a href="incomestat.aspx" target="mainframe"><i class="icon-nav"></i>收益明细</a></li>
                                <li><a href="costlog.aspx" target="mainframe"><i class="icon-nav"></i>结算记录</a></li>
                                <li><a href="transfer.aspx" target="mainframe"><i class="icon-nav"></i>余额转账</a></li>
                                <li><a href="transferlist.aspx" target="mainframe"><i class="icon-nav"></i>转账记录</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <li class="item hoverToggle-wrapper"><a href="javascript:void(0);" class="trigger"><i
                    ...
                    <div class="hoverToggle hoverToggle-bottomRight service-popup">
                        ...
                        <dl>
                                ...
                                <dd>
                                   <a target="_blank"
                            href="http://wpa.qq.com/msgrd?v=3&uin=12345678&site=qq&menu=yes"><img border="0"
