<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="viviapi.WebUI.Userlogin.safety.index" %>
    ...
    <div id="frame-wrapper">
        ...
        <div id="frame-header">
            ...
            <ul id="headerNav">
                ...
                <li class="current"><a href="/Userlogin/safety/index.aspx">安全中心</a></li>
            </ul>
            <ul id="header-info">
        ...
        <div id="frame-content">
            <div class="mainbar">
                <div class="module" style="height: 823px;">
                    <iframe src="safeques.aspx" marginwidth="0" marginheight="0" frameborder="0"
                    ...
                    <div class="mbody" style="height: 793px;">
                        <div class="sideNav-content" style="height: 759px;">
                            ...
                            <ul id="side-menu" class="text-nav">
                                <li class="current"><a href="safeques.aspx" target="mainframe"><i class="icon-nav"></i>
                                    设置密保</a></li>
                                <li><a href="repassword.aspx" target="mainframe"><i class="icon-nav"></i>密码修改</a></li>
                                <li><a href="cashpass.aspx" target="mainframe"><i class="icon-nav"></i>提现密码</a></li>
                                <li><a href="modiphone.aspx" target="mainframe"><i class="icon-nav"></i>手机认证</a></li>
                                <li><a href="modiemail.aspx" target="mainframe"><i class="icon-nav"></i>修改邮箱</a></li>
                                <li><a href="safetrna.aspx" target="mainframe"><i class="icon-nav"></i>实名认证</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
