<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.UserChannels" Codebehind="UserChannels.aspx.cs" %>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table1">
            <tr>
                <td align="center" style="font-weight: bold; font-size: 14px; background-image: url(../style/images/topbg.gif);color: teal; background-repeat: repeat-x; height: 24px">
                    商户通道管理 <asp:Button ID="btnAllOpen" runat="server" Text="全部开启" OnClick="btnAllOpen_Click"/>  <asp:Button ID="btnAllColse" runat="server" Text="全部关闭" OnClick="btnAllColse_Click"/></td>
            </tr>
            <tr>
                <td colspan="2">
                            ...
                            onitemcommand="rpt_paymode_ItemCommand">
                                ...
                                <ItemTemplate>
                                    <tr style="background-color: #EFF3FB">
                                        ...
                                        <td>
                                            <div class="height40">                                                                                                
                                                <a id="<%#Eval("typeId")%>" class="bottonstyle02"><%#Eval("plmodestatus") == "right" ? "关闭" : "开启"%></a>
                                            </div>
                                        </td>
                                    </tr>
                                </ItemTemplate>
