namespace viviapi.WebUI.Managements.User
{
    ...
    public class trans_details : ManagePageBase
    {
        protected Button btnSearch;
        protected tenpay_batch_trans_detail detailBLL = new tenpay_batch_trans_detail();
        ...
        private void LoadData()
        {
            ...
            if (!string.IsNullOrEmpty(this.txtrec_acc.Text))
            {
                searchParams.Add(new SearchParam("rec_acc", this.txtrec_acc.Text.Trim()));
            }
            ...
            DataSet set = this.detailBLL.PageSearch(searchParams, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, orderby);
