<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.agentratelimit" CodeBehind="agentratelimit.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp991" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    QQ钱包：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp981" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    京东钱包：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp971" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    银联钱包：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp911" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    手机网银：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp961" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    手机支付宝：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp951" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    手机微信：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp941" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    手机QQ：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp931" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    手机京东：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp921" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    微信H5：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp891" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    百度钱包：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp881" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    支付宝H5：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp871" runat="server" Width="80px"></asp:TextBox>
                </td>
                <td class="td2a">
                    QQ钱包H5：
                </td>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp861" runat="server" Width="80px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td2a">
            ...
            <tr>
                ...
                <td class="td1a">
                    <asp:TextBox ID="txtp901" runat="server" Width="80px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="td2a">
