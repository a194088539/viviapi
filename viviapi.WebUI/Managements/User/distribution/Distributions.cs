namespace viviapi.WebUI.Managements.User.distribution
{
    ...
    public class Distributions : ManagePageBase
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (data != null)
                {
                    ...
                    {
                        row["sName"] = viviapi.BLL.distribution.GetStatusText(row["status"]);
                    }
        ...
        private DataSet GetData()
        {
            ...
            return viviapi.BLL.distribution.PageSearch(searchParams, this.Pager1.PageSize, this.Pager1.CurrentPageIndex, orderby);
        }
