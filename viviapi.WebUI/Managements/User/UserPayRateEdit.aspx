<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.UserPayRateEdit"
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        <tr>
            <td colspan="10">
                ...
                &nbsp;<asp:Button ID="btnCopy" runat="server" Text="复制默认比例" OnClick="btnCopy_Click" />
            </td>
        </tr>
        <tr>
            <td class="td2a">
