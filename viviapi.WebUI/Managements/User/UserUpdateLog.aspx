<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.UserUpdateLog" Codebehind="UserUpdateLog.aspx.cs" %>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table1">
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnDel" runat="server" Text="删 除" CssClass="button" 
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr style="background-color:#EFEFEF">
                            <td  style="height:16px;">
                                <aspxc:AspNetPager ID="Pager1" runat="server" OnPageChanged="Pager1_PageChanged" AlwaysShow="True" CustomInfoHTML="总记录数：%RecordCount%&nbsp;总页数：%PageCount%&nbsp;当前页：%CurrentPageIndex%&nbsp;"
