<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.UserEdits" Codebehind="UserEdit.aspx.cs" %>
        ...
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                ...
                <td class="td1">
                    ...
                    </asp:DropDownList><asp:DropDownList ID="ddlmemvip" runat="server" Width="150px"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td class="td2">
