<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.SupplierList" Codebehind="SupplierList.aspx.cs" %>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" id="table_zyads" style="width: 100%;height: 100%; border: #c9ddf0 1px solid; background-color: White;">
            <tr>
                <td align="center" colspan="2" style="font-weight: bold; font-size: 14px; background-image: url(../style/images/topbg.gif);
                    ...
                    供应商列表 <asp:Button ID="btnAdd" runat="server" Text="新 增" OnClick="btnAdd_Click"  /></td>                 
            </tr>                   
            <tr>
                <td align="center">
                    <asp:GridView ID="GVSupplier" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href="SupplierPayrate.aspx?supid=<%# Eval("code") %>&n=<%#Eval("name")%>" class="cvlink">费率</a>
                                    <a href="SupplierEdit.aspx?cmd=edit&ID=<%# Eval("ID") %>" class="cvlink">编辑</a> 
                                    </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
