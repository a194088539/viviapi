    ...
    public class TocashSchemeModi : ManagePageBase
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.isUpdate)
                {
                    if (viviapi.BLL.Settled.TocashScheme.Update(this.model))
                    {
                        flag = true;
                    }
                }
                ...
                {
                    this.model.type = 1;
                    if (viviapi.BLL.Settled.TocashScheme.Add(this.model) > 0)
                    {
                        flag = true;
                    }
                }
        ...
        public TocashSchemeInfo model
        {
            get
            {
                if (this._ItemInfo == null)
                {
                    if (this.isUpdate)
                    {
                        this._ItemInfo = viviapi.BLL.Settled.TocashScheme.GetModel(this.ItemInfoId);
                    }
                    else
                    {
