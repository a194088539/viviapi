<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Order.changeorde" Codebehind="changeorder.aspx.cs" %>
            ...
            <tr>
                ...
                <td class="td1">
                    <asp:RadioButtonList ID="rblOrdClass" runat="server" RepeatDirection="horizontal">                                        
                                <asp:ListItem Value="1" >网银订单</asp:ListItem>
                                <asp:ListItem Value="2" Selected="true">卡类订单</asp:ListItem>
