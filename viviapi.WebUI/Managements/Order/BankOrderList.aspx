<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Order.BankOrderList" Codebehind="BankOrderList.aspx.cs" %>
            ...
            <td>
                ...
                <asp:TextBox ID="txtpromid" runat="server" Width="30px"></asp:TextBox>--%>
                            <asp:DropDownList ID="ddlChannelType" runat="server" Width="95px">
                                ...
                                <asp:ListItem Value="98">QQ钱包</asp:ListItem>
                                <asp:ListItem Value="97">京东钱包</asp:ListItem>
                                <asp:ListItem Value="88">百度钱包</asp:ListItem>
                                <asp:ListItem Value="96">手机网银</asp:ListItem>
                                <asp:ListItem Value="95">手机支付宝</asp:ListItem>
                                <asp:ListItem Value="94">手机微信</asp:ListItem>
                                <asp:ListItem Value="93">手机QQ</asp:ListItem>
                                <asp:ListItem Value="92">手机京东</asp:ListItem>
                                <asp:ListItem Value="87">支付宝h5</asp:ListItem>
                                <asp:ListItem Value="89">微信h5</asp:ListItem>
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("id")%>')">
                                            ...
                                            <td>
                                                ...
                                                <asp:Button ID="btnRest" runat="server" Text="补单" CommandName="ResetOrder" CommandArgument='<%#GetParm(Eval("orderid"),Eval("supplierId"),Eval("refervalue"))%>' />
