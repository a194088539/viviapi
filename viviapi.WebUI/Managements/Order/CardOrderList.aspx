<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Order.CardOrderList" Codebehind="CardOrderList.aspx.cs" %>
                ...
                <table>
                    <tr>
                        <td colspan="3">
                            ...
                            &nbsp&nbsp<asp:DropDownList ID="ddlOrderStatus" runat="server" Width="95px">
                                ...
                                <asp:ListItem Value="32">部份成功</asp:ListItem>
                            </asp:DropDownList>
                            &nbsp&nbsp<asp:DropDownList ID="ddlNotifyStatus" runat="server" Width="95px">
                                    ...
                                    <ItemTemplate>
                                        <tr bgcolor="#EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("id")%>')">
                                            ...
                                            <td>
                                                ...
                                                <asp:Button ID="btnChange" runat="server" Text="调"  CommandName="Change" CommandArgument='<%# Eval("orderid")%>' Visible="false"/>                                                                           
                                            </td>                                            
                                        </tr>
