<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Order.SmsReportList" Codebehind="SmsReportList.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function sendInfo(id) {
            window.open("SmsOrderShow.aspx?id=" + id, "查看订单", "height=760,width=800");
        }        
    </script>
    <script type="text/javascript">
