<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Order.SmsOrderShow" Codebehind="SmsOrderShow.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td1">
                <asp:Label ID="lbldescnum" runat="server"></asp:Label>
            </td>
        </tr>
        <tr >
            <td class="td2">
