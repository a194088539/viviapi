<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.feedback.List" Codebehind="list.aspx.cs" %>
                    ...
                    <asp:Repeater ID="rptIamges" EnableViewState="false" runat="server" OnItemDataBound="rptUsersItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #EFF3FB" ondblclick="javascript:sendInfo('<%# Eval("id")%>')">
                                ...
                                <td>
                                     <a href='../user/UserEdit.aspx?ID=<%# Eval("userId") %>'><strong>
                                        <%# Eval("userName")%>
                                    </strong></a>
                                </td>
                                 <td>
                                ...
                                <td>
                                    <%# Enum.GetName(typeof(viviapi.Model.feedbackstatus),Eval("status"))%>
                                </td>
                                <td>
                                    <%# Eval("reply")%>
                                </td>
