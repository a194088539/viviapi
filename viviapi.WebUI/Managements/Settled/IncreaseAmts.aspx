<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Settled.IncreaseAmts" Codebehind="IncreaseAmts.aspx.cs" %>
                    ...
                    <asp:Repeater ID="rptTrades" EnableViewState="false" runat="server" OnItemDataBound="rptUsersItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #EFF3FB">
                                ...
                                <td>
                                     <%#Enum.GetName(typeof(viviapi.Model.Settled.optypeenum),Eval("optype"))%>             
                                </td>
                                <td>
