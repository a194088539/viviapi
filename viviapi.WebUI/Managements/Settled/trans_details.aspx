<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.User.trans_details" Codebehind="trans_details.aspx.cs" %>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table1">
            ...
            <tr>
                <td>
                    ...
                    账号
                    <asp:TextBox ID="txtrec_acc" runat="server"></asp:TextBox>
                     开始：
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #EFF3FB">
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <%#detailBLL.GetStatusText(Eval("status"))%>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:Button ID="btnquery" runat="server" Text="重新查询" CommandName="query" CommandArgument='<%# Eval("package_id")%>' />
                                    </td>                                     
                                </tr>
                            </ItemTemplate>
