<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.User.distribution.Distributions2" Codebehind="Distributions2.aspx.cs" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnExport" runat="server" CssClass="button" Text="导出"
                     ...
                     <div id="divmoney">
                    <span style="color: #ff0000; text-align: left">总付款金额：<% = total_amount%></span>
                </div>                   
                </td>
            </tr>
            <tr>
                        ...
                        <asp:Repeater ID="rptTrades"  runat="server" 
                            ...
                            <ItemTemplate>
                                <tr style="background-color: #EFF3FB">
                                    ...
                                    <td>
                                        <%# viviapi.BLL.SettledFactory.GetSettleBankName(Eval("bankCode").ToString())%> <%# Eval("bankBranch")%> <br />
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        ...
                                        <asp:Button ID="btnReissue" runat="server" Text="补发" ToolTip="手动回发" CommandName="Reissue" CommandArgument='<%# Eval("id")%>' Visible="false" />
                                    </td>                                     
                                </tr>
                            </ItemTemplate>
