<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.Withdraw.AgentDistsSchemes" Codebehind="AgentDistsSchemes.aspx.cs" %>
        ...
        <table width="100%" border="0" cellpadding="1" cellspacing="1" id="table_zyads" style="width: 100%;
            ...
            <tr>
                <td align="left" colspan="2" style="font-weight: bold; font-size: 14px; background-image: url(../style/images/topbg.gif);
                    ...
                    代发规则 <asp:Button ID="btnAdd" runat="server" Text="新 增" OnClick="btnAdd_Click"  />
                </td>
            </tr>
            <tr>
                <td align="center">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <a href="AgentDistsSchemeModi.aspx?cmd=edit&amp;ID=<%# Eval("ID") %>">编辑</a> || 
