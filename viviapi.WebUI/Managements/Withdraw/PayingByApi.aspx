<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.PayingByApi" Codebehind="PayingByApi.aspx.cs" %>
                        ...
                        <asp:Repeater ID="rptList" runat="server" onitemcommand="rptList_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr bgcolor="#EFF3FB">
                                    ...
                                    <td>
                                        <asp:Button ID="btnCancel" runat="server" Text="取消" CommandArgument='<%# Eval("ID") %>' CommandName="Cancel" />
                                    </td>
