<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.User.ManageLoginLog" Codebehind="ManageLoginLog.aspx.cs" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="btnDelete" runat="server" CssClass="button" Text=" 删 除" 
                        OnClientClick="return Del_Confirm();" onclick="btnDelete_Click"></asp:Button>
                    &nbsp; &nbsp;
                </td>
            </tr>           
            <tr>
