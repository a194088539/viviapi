                ...
                <td align="center">
                    <asp:GridView ID="GVChannel" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>    
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <input type="button" value="设 置" onclick="javascript:location.href='ChannelTypeEdit.aspx?id=<%#Eval("id")%>'" />
                                    ||
                                    <input type="button" value="销卡设置" onclick="javascript:location.href='mutisupp.aspx?id=<%#Eval("id")%>'" />                                      
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
