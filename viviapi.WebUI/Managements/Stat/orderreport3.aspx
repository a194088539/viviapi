<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Managements.User.orderreport3" Codebehind="orderreport3.aspx.cs" %>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" class="table1">
            ...
            <tr>
                <td>
                    ...
                    <asp:CheckBox ID="chk_showorderid" runat="server" Text="显示订单号" /> 
                    <asp:Button ID="btnSearch" runat="server" CssClass="button" Text=" 查 询 " OnClick="btnSearch_Click">
                    </asp:Button>  
                    
                     <div id="divmoney">
                                <span style="color: #ff0000; text-align: left">总收入：<%=wzfmoney%></span> 
                                <span style="color: #ff0000; text-align: left;" runat="server" id="spangmmoney">总支出：<%=yzfmoney%></span>
                            </div>                 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="center">                   
                        <asp:Repeater ID="rptorders" EnableViewState="false" runat="server">
                            <HeaderTemplate>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <%# Eval("billNo")%><br />
