namespace viviapi.WebUI.Managements.User
{
    ...
    public class orderreport3 : ManagePageBase
    {
        protected Button btnSearch;
        protected CheckBox chk_showorderid;
        ...
        private void LoadData()
        {
            ...
            {
                int paramValue = int.Parse(this.ddlSupplier.SelectedValue);
                searchParams.Add(new SearchParam("supplier", paramValue));
            }
            ...
            try
            {
                this.wzfmoney = Convert.ToDecimal(set.Tables[1].Compute("sum(Amt)", "type=1")).ToString("f2");
                this.yzfmoney = Convert.ToDecimal(set.Tables[1].Compute("sum(Amt)", "type=2")).ToString("f2");
            }
            catch
            {
            }
