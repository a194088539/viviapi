<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.Managements.Login" Codebehind="login.aspx.cs" %>
...
<body>
    <form id="form1" runat="server" onsubmit="return checkform()">
        ...
        <div id="Main">
            ...
            <div id="Login">
                ...
                <div class="login_bg">
                    ...
                    <div class="input_id">
                        帐 号：<input class="colorblur" id="UserNameBox" runat="server" type="text" name="UserNameBox" value="" /></div>
                    <div class="input_pwd">
                        密 码：<input class="colorblur" id="pas" runat="server" type="password" name="pas" value="" style="width: 86px"
                    ...
                    <div class="input_pwd">
                        验证码：<input class="colorblur" onblur="this.style;" maxlength="5" size="6" name="CCode" id="CCode" />
        ...
        <div id="Bot">
            <span>Copyright &copy; 2018 <a href="#" target="_blank"></a>.All Rights Reserved</span></div>
    </form>
