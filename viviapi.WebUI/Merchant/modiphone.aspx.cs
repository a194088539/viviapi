    ...
    public class modiphone : UserPageBase
    {
        ...
        private void InitForm()
        {
            ...
            else
            {
                ...
                this.litphone.Text = this.litphone.Text + "<span id=\"phoneputbox\"><input name=\"phone\" type=\"text\" id=\"phone\" value=\"\" maxlength=\"11\" class=\"txt_02\" size=\"50\"/><em class=\"txtr b_m_l b_m_r\">* <a href=\"javascript:;\" id=\"sendmsg\">发送验证码</a></em><em id=\"phoneinput_close\"><a href=\"javascript:;\"> 取消</a></em></span>";
            }
        }
