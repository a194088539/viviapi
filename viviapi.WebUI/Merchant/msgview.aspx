<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="msgview.aspx.cs" Inherits="viviapi.WebUI.LongBao.merchant.msgview" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                   <tr>
                                     <td align="left" valign="top" style="font-family:'微软雅黑'; color:#333333; font-size:13px;">标题：<asp:Literal 
                                             ID="lit_title" runat="server"></asp:Literal>
                                       </td>
                                     <td align="left" valign="top" style="font-family:'微软雅黑'; color:#999999;">时间：<asp:Literal 
                                             ID="lit_addtime" runat="server"></asp:Literal></td>
                                   </tr>
                                   <tr>
                                     <td colspan="2" align="left" valign="top" style="font-family:'微软雅黑'; color:#333333;">内容：
                                     <asp:Literal 
                                             ID="lit_content" runat="server"></asp:Literal>
                                     </td>
                                   </tr>
                                 </table>
    </form>
