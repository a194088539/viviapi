<%@ Page Title="" Language="C#" MasterPageFile="~/Merchant/Base.Master" AutoEventWireup="true"
    CodeBehind="agentdists.aspx.cs" Inherits="viviapi.WebUI.Merchant.agentdists" %>
        ...
        <div id="search">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                       系统交易号
                       <input  id="txttrade_no" runat="server" type="text"  maxlength="30"  />
                       商户交易号
                       <input  id="txtout_trade_no" runat="server" type="text"  maxlength="30"  />
            ...
            <asp:Repeater ID="rptDetails" runat="server" 
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnSure" runat="server"  Text="确认" CommandArgument='<%# Eval("trade_no")%>' CommandName="sure" Visible="false" />
                            <asp:Button ID="btnCancel" runat="server" Text="取消" CommandArgument='<%# Eval("trade_no")%>' CommandName="cancel"  Visible="false"  />
                        </td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
