<%@ Page Title="" Language="C#" MasterPageFile="~/Merchant/Base.Master" AutoEventWireup="true"
    CodeBehind="ordercards.aspx.cs" Inherits="viviapi.WebUI.Merchant.ordercards" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function replenish(orderid) {
            $.get("/merchant/ajax/replenish.ashx?v=" + Math.random(), { type: "2", order: orderid },
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td>
                        ...
                        =
                        <input name="okey" type="text" id="okey" runat="server" maxlength="30" value="" style="border: 1px solid #ccc;"/>
                        <label>
                            &nbsp;
            ...
            <tr>
                ...
                <td height="30" align="center" bgcolor="#FFFFFF" colspan="12">
                    本页提交订单：<%=pageordertotal%>笔 │ 本页成功订单：<%=pageordersucctotal%>笔 │ 总提交订单 ：<%=totalordertotal%>笔
                                                    │ 总成功订单：
                                                    <%=totalsuccordertotal%>笔
                                                     本页提交金额：<%=pagerefervalue%>元 │ 本页成功金额：<%=pagerealvalue%>元 │ 总提交金额 ：<%=totalrefervalue%>元
                                                    │ 总成功金额：
                                                    <%=totalrealvalue%>元
                </td>
