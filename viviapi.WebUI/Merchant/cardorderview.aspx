<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cardorderview.aspx.cs" Inherits="viviapi.WebUI.LongBao.merchant.cardorderview" %>
...
.button {font-size:9pt;height:20px;border-width:1px;cursor:hand;background:url(/merchant/static/style/images/cxbg.gif);}
    ...
    <div class='Mir_List'>
            ...
            <div class='M_Item'>
                <ul>
                   ...
                   <li class='li_1'><a href="<%=referUrl%>" target="_blank"><%=CutWord(referUrl,30)%></a>&nbsp;<input value="复制地址" type="button"  class="button" onclick="copyToClipboard('<%=referUrl%>')" /></li>
                </ul>
            </div> 
            <div class='M_Item Pub'>
                <ul>
                    <li class='li_0'>异步通知：</li>
                    <li class='li_1'><a href="<%=notifyurl%>" target="_blank"><%=CutWord(notifyurl, 30)%></a>&nbsp;<input value="复制地址" type="button" class="button" onclick="copyToClipboard('<%=notifyurl%>')"/></li>
                </ul>
            </div>    
             <div class='M_Item Pub'>
                <ul>
             ...
             <div class='M_Item'>
                <ul>
                    <li class='li_0'>备注：</li>
                    <li class='li_1'>
                       <li class='li_1'><asp:Label ID="lblmessage" runat="server" Width="300px"></asp:Label></li>
                </ul>
            </div> 
