<%@ Page Title="" Language="C#" MasterPageFile="~/Merchant/Base.Master" AutoEventWireup="true"
    CodeBehind="recharge.aspx.cs" Inherits="viviapi.WebUI.Merchant.recharge" %>
 ...
 <script src="/js/jquery.zxxbox.3.0.js" type="text/javascript"></script>
    <script type="text/javascript">
        jQuery(document).ready(function() {
            $("#ctl00_ContentPlaceHolder1_ibtnSave").click(function() {
                ...
                var money = $("#ctl00_ContentPlaceHolder1_txtRechargeMoney").val();
                if (money == "") {
                    $("#ctl00_ContentPlaceHolder1_callinfo").html(errico + "请输入充值金额");
                    return false;
                };
            });

            $("#ctl00_ContentPlaceHolder1_txtRechargeMoney").blur(function() {
                getactualMoney();
            });
        ...
        function getactualMoney() {
            $("#ctl00_ContentPlaceHolder1_txtactualMoney").val("0.00");
            var _val = $("#ctl00_ContentPlaceHolder1_txtRechargeMoney").val();
            var _bank = $('input:radio[name="bank_list"]:checked').val();

            if (_val != "") {
                $.get("/merchant/ajax/GetActualMoney.ashx?t=" + Math.random(), { rechargemoney: _val, bank: _bank },
            function(data) {
                $("#ctl00_ContentPlaceHolder1_txtactualMoney").val(data);
            })
            }
        }
    </script>
    ...
    <script language="javascript">        
        $(document).ready(function() {
            ...
            //输入限制
            $("#ctl00_ContentPlaceHolder1_txtRechargeMoney").keypress(function(event) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="list_content">
        <div id="title">
            在线充值&nbsp;<img id="loading" width="0" height="0" src="/merchant/static/style/008.gif" /></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td align="left" class="line_01">
                    <asp:TextBox ID="txtRechargeMoney" runat="server" MaxLength="15" CssClass="txt_02"></asp:TextBox>                                                                     
                </td>
                <td height="39" align="left" class="line_01">
                </td>
            </tr>
            <tr>
                ...
                <td align="left" class="line_01">
                    <asp:TextBox ID="txtactualMoney" runat="server" MaxLength="15" CssClass="txt_02"></asp:TextBox>            
                </td>
                <td height="39" align="left" class="line_01">
                </td>
            </tr>
                ...
                <td height="39" colspan="10">
                    <div class="r_content">
                                                                    ...
                                                                    <dl class="czk">
                                                                        <dt>选择充值方式</dt>
                                                                        <dd>
                                                                            <input type="radio" name="bank_list" id="bank_list" value="967" onclick="selectBank()" checked="checked"><img
                                                                                                        src="/style/images/paybank/pic08.jpg" align="absmiddle" alt="工商银行" title="工商银行" /></dd>
                                                                        <dd>
                                                                            <input type="radio" name="bank_list" id="Radio1" value="970" onclick="selectBank()"><img
                                                                                                        src="/style/images/paybank/pic09.jpg" align="absmiddle" alt="招商银行" title="招商银行" />
                                                                                </dd>
                                                                        <dd>
                                                                    ...
                                                                    <div class="content_bot">
                                                                        <asp:Button ID="btnsubmit" runat="server" Text="下一步" CssClass="btn btn-primary" 
                                                                            onclick="btnsubmit_Click" OnClientClick="paySubmit()" /><span class="txtr" id="callinfo" runat="server" style="color: Red; font-weight: bold">
                                                                                                    </span>
                                                                    </div>
                                                                </div>
    ...
    <div id="selBank" style="padding:40px; display: none;">
			...
			<div id="payResult">
				<div style="margin-bottom:10px">· 请在新打开的页面完成支付，支付成功即完成充值。</div>
