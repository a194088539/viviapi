<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.business.Order.CardOrderShow" Codebehind="CardOrderShow.aspx.cs" %>
...
<body>
    ...
    <table cellspacing="0" cellpadding="0" width="100%" border="0">
        ...
        <tr>
            ...
            <td class="td1">
                <asp:Label ID="lblsupplierRate" runat="server" Visible="false"></asp:Label>
            </td>
            <td class="td2">
                
            </td>
            <td class="td1">
                <asp:Label ID="lblsupplierAmt" runat="server" Visible="false"></asp:Label>
            </td>           
        </tr>
        <tr>
             <td class="td2">
            ...
            <td class="td1">
                <asp:Label ID="lblpromRate" runat="server" Visible="false"></asp:Label>
            </td>
            <td class="td2">
                
            </td>
            <td class="td1">
                <asp:Label ID="lblpromAmt" runat="server" Visible="false"></asp:Label>
            </td>
        </tr>
        <tr>            
            <td class="td2">
            ...
            <td class="td1">
                <asp:Label ID="lblprofits" runat="server" Visible="false"></asp:Label>
            </td>
            <td></td>
            <td></td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4" class="td1" style="word-wrap:break-word;overflow:hidden; ">
