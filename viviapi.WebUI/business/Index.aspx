<%@ Page Language="C#" AutoEventWireup="true" Inherits="viviapi.WebUI.Business.Index" Codebehind="Index.aspx.cs" %>
                        ...
                        <div class="left b_size" style="margin: 1px; width: 99%">
                            <div class="addrtitle f_size">
                                <p>
                                    商户总数：<%=userscount%>个</p>
                                <p>
                                    商户今日充值量：<%=todaytotalAmt%></p>
                                <p>
                                    商户当月充值量：<%=todaytotalAmt%></p>
                                <p>
                                    商户总充值量：<%=todaytotalAmt%></p>
                                <p>
                                    员工当月提成：<%=monthcommission%></p>
                                  <p> 推广连接获取：http://www.long-bao.com/Register.aspx<asp:Literal ID="litlinks" runat="server"></asp:Literal>     
                                  </p>
                            </div>
                        </div>
                    </div>
