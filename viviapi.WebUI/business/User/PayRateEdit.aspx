<%@ Page Language="C#" AutoEventWireup="True" Inherits="viviapi.WebUI.business.User.PayRateEdit" Codebehind="PayRateEdit.aspx.cs" %>
            ...
            <table cellspacing="0" cellpadding="0" width="100%" border="0">                
                <tr >
                    <td class="td2">
                        费率组 ：</td>
                    <td class="td1">
                        <asp:TextBox ID="txtlevName" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="bank" >
                    <td class="td2">
