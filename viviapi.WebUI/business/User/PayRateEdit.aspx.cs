namespace viviapi.WebUI.business.User
{
    ...
    public partial class PayRateEdit : BusinessPageBase
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                decimal num28 = decimal.Parse(this.txtp91.Text) / 100M;
                decimal num29 = decimal.Parse(this.txtp92.Text) / 100M;
                decimal num30 = decimal.Parse(this.txtp93.Text) / 100M;
                decimal num31 = decimal.Parse(this.txtp97.Text) / 100M;
                decimal num32 = decimal.Parse(this.txtp89.Text) / 100M;
                decimal num33 = decimal.Parse(this.txtp88.Text) / 100M;
                decimal num34 = decimal.Parse(this.txtp87.Text) / 100M;
                decimal num35 = decimal.Parse(this.txtp86.Text) / 100M;
                ...
                this.model.p90 = num27;
                this.model.p91 = num28;
                this.model.p92 = num29;
                this.model.p93 = num30;
                this.model.p97 = num31;
                this.model.p89 = num32;
                this.model.p88 = num33;
                this.model.p87 = num34;
                this.model.p86 = num35;
                if (this.isUpdate)
                {
        ...
        private void ShowInfo()
        {
            if (this.isUpdate && (this.model != null))
            {
                ...
                num = Convert.ToDecimal(this.model.p91) * 100M;
                this.txtp91.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p92) * 100M;
                this.txtp92.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p93) * 100M;
                this.txtp93.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p97) * 100M;
                this.txtp97.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p89) * 100M;
                this.txtp89.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p88) * 100M;
                this.txtp88.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p87) * 100M;
                this.txtp87.Text = num.ToString("0.00");
                num = Convert.ToDecimal(this.model.p86) * 100M;
