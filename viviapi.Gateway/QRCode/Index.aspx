<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="viviapi.gateway.QRCode.Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>扫码支付 </title>
    <link id="linkWebCss1" href="/App_Themes/Cashier/Web.min.css" rel="stylesheet" />
    <link id="linkWeixinCss1" href="/App_Themes/Cashier/Weixin.css" rel="stylesheet" />
    <link id="linkPaymentDialogCss1" href="/App_Themes/Cashier/PaymentDialog.css" rel="stylesheet" />
    <style type="text/css">
