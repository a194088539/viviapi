namespace viviapi.gateway.WeiXin
{
    using System;
    using System.Web.UI;
    ...
    {
        protected HtmlLink linkPaymentDialogCss;
        protected HtmlLink linkWebCss;
        protected HtmlLink linkWeixinCss;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Cryptography.MD5(this.suppId.ToString() + this.orderAmt.ToString() + this.orderid + bankcode + payurl + Constant.ParameterEncryptionKey) == this.sign)
            {
                if (suppId == 10012 || suppId == 6002)
                {
                    ...
                    this.Image2.ImageUrl = "/MakeQRCode.aspx?data=" + payurl;
                    //}
                    //else
                    //{
                    //    this.wxorderid = this.orderid;
