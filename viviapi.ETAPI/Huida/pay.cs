...
namespace viviapi.ETAPI.Huida
{
    public class pay : ETAPIBase
    {
        private static int suppId = 10009;

        internal string notifyUrl
        {
            get
            {
                return this.SiteDomain + "/notify/Huida/Bank_Notify.aspx";
            }
        }
        ...
        {
            string str = "http://epay.scqyda.com/cgi-bin/netpayment/pay_gate.cgi";
            if (!string.IsNullOrEmpty(this._suppInfo.jumpUrl))
                str = this._suppInfo.jumpUrl + "/switch/huida.aspx";
            ...
            else if (BankID == "992")     //支付宝
            {
                sourceData1.Add("choosePayType", "4");
                sourceData1.Add("bankCode", "MOBOACC");
            }
            else if (BankID == "1008")    //QQ
            {
                sourceData1.Add("choosePayType", "6");
                sourceData1.Add("bankCode", "MOBOACC");
            }
            else if (BankID == "2001")    //京东
            {
                sourceData1.Add("choosePayType", "6");
                sourceData1.Add("bankCode", "MOBOACC");
            }
        ...
        public string PayBankApp(string orderid, Decimal orderAmt, string BankID, HttpContext Context)
        {
            string str = "http://epay.scqyda.com/cgi-bin/netpayment/pay_gate.cgi";
            if (!string.IsNullOrEmpty(this._suppInfo.jumpUrl))
                str = this._suppInfo.jumpUrl + "/switch/huida.aspx";
                ...
                str = this._suppInfo.postBankUrl;
            Dictionary<string, string> sourceData1 = new Dictionary<string, string>();
            sourceData1.Add("apiName", "WAP_PAY_B2C");
            sourceData1.Add("apiVersion", "1.0.0.0");
            sourceData1.Add("platformID", this.suppAccount);
            sourceData1.Add("merchNo", this.suppUserName);
            sourceData1.Add("orderNo", orderid);
            ...
            sourceData1.Add("merchParam", "Game");
            sourceData1.Add("tradeSummary", "Game|1");
            if (BankID == "1006")     //支付宝WAP
            {
                sourceData1.Add("choosePayType", "5");
                sourceData1.Add("bankCode", "MOBOACC");
            }
            else if (BankID == "1007")     //微信WAP
            {
                sourceData1.Add("choosePayType", "4");
                sourceData1.Add("bankCode", "MOBOACC");
            }
            else if (BankID == "2005")    //微信H5
            {
                sourceData1.Add("choosePayType", "6");
                sourceData1.Add("bankCode", "MOBOACC");
            }
            else if (BankID == "1009")    //QQ WAP
            {
                sourceData1.Add("choosePayType", "6");
                sourceData1.Add("bankCode", "MOBOACC");
            }
