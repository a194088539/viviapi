...
namespace viviapi.ETAPI.Huida
{
    ...
    public class MobaopayConfig
    {
        ...
        static MobaopayConfig()
        {
            ...
            mbp_key = "e2492feb8a897d219e9f4f0f34223d51";

            //支付系统网关地址
            //商户用地址-正式
            mobaopay_gateway = "http://epay.scqyda.com/cgi-bin/netpayment/pay_gate.cgi";

            //商户接受支付通知地址(商户自己系统的地址)
            merchant_notify_url = "http://pay.qianfupay.com/notify/Huida/Bank_Notify.aspx";

            //商户平台号及商户帐号
            platform_id = "866375370013778";
            merchant_acc = "866375370013778";
