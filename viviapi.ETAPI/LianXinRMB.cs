...
{
    public class LianXinRMB : ETAPIBase
    {
        ...
        public void ReturnBank()
        {
            ...
            try
            {
                ...
                new OrderBank().DoBankComplete(LianXinRMB.suppId, orderId, supplierOrderId, status, opstate, msg, Decimal.Parse(s), new Decimal(0), false, true);
        ...
        public void Notify()
        {
            ...
            try
            {
                ...
                new OrderBank().DoBankComplete(LianXinRMB.suppId, orderId, supplierOrderId, status, opstate, msg, Decimal.Parse(s), new Decimal(0), true, false);
                HttpContext.Current.Response.Write("OK");
            }
            catch (Exception ex)
            {
