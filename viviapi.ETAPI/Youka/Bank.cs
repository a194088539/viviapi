...
namespace viviapi.ETAPI.Youka
{
    public class Bank : ETAPIBase
    {
        private static int suppId = 1008;

        internal string returnurl
        {
            get
            {
                return this.SiteDomain + "/return/Youka/Bank_Return.aspx";
            }
        }
        ...
        internal string notifyUrl
        {
            get
            {
                return this.SiteDomain + "/notify/Youka/Bank_Notify.aspx";
            }
        }
