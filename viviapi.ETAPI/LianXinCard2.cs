...
{
    public class LianXinCard2 : ETAPIBase
    {
        private static int suppId = 902;

        internal string notify_url
        {
            get
            {
                return this.SiteDomain + "/notify/LianXin_Card_Notify.aspx";
            }
        }

        public LianXinCard2()
          : base(LianXinCard2.suppId)
        {
        }
        ...
        public void CardNotify()
        {
            ...
            try
            {
                ...
                new OrderCard().ReceiveSuppResult(LianXinCard2.suppId, orderId, supplierOrderId, status, opstate, str9, Decimal.Parse(s), new Decimal(0), str9);
