...
{
    public class LianXinCard : ETAPIBase
    {
        ...
        public void CardNotify()
        {
            ...
            try
            {
                ...
                new OrderCard().ReceiveSuppResult(LianXinCard.suppId, orderId, supplierOrderId, status, opstate, str9, Decimal.Parse(s), new Decimal(0), str9);
